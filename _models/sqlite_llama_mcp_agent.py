...
# MODEL_ID = "meta-llama/llama-3.2-1b-instruct" # https://router.huggingface.co/novita/v3/openai/
# MODEL_ID = "llama-3.3-70b" # https://router.huggingface.co/cerebras/v1/
...
with open("hf_key2", "r") as key_file:
    api_key = key_file.read().strip()
    
# url_ ="https://api-inference.huggingface.co/v1/"
# url_="https://router.huggingface.co/novita/v3/openai/" # for meta-llama/llama-3.2-1b-instruct
# url_="https://router.huggingface.co/cerebras/v1/" # for meta-llama/Llama-3.3-70B-Instruct
url_ ="http://localhost:8888/v1/"
# url_ ="http://localhost:8080/v1/"
